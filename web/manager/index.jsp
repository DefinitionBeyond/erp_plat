        ...
        <aside class="Hui-aside">
            ...
            <div class="menu_dropdown bk_2">
				<dl id="menu-system">
	                ...
	                <dd>
	                    <ul>
	                    	<li><a _href='xxxx-mgr.jsp' data-title='功能1' href="javascript:void(0)">查看全部xxx信息</a></li>
	                    	<li><a _href='manager.jsp' data-title='工号信息管理' href="javascript:void(0)">工号信息管理</a></li>
	                    	<li><a _href='' data-title='功能3' href="javascript:void(0)">功能3</a></li>
	                    </ul>
	                </dd>
	            </dl>      
	            <dl id="menu-system">
	                <dt>
	                	<i class="Hui-iconfont">&#xe62e;</i>XX（2）模块
	                    <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
	                </dt>
	                <dd>
	                    <ul>
	                    	<li><a _href='' data-title='功能1' href="javascript:void(0)">功能1</a></li>
	                    	<li><a _href='' data-title='功能2' href="javascript:void(0)">功能2</a></li>
	                    	<li><a _href='' data-title='功能3' href="javascript:void(0)">功能3</a></li>
	                    </ul>
	                </dd>
	            </dl>  
        ...
        <section class="Hui-article-box">
            ...
            <div id="iframe_box" class="Hui-article">
                <div class="show_iframe">
                    ...
                    <iframe id="iframeRight" src="main.jsp"></iframe>
                </div>
            </div>
        </section>
        <script type="text/javascript" src="../lib/jquery/1.9.1/jquery.min.js"></script>
        <script type="text/javascript" src="../lib/layer/2.1/layer.js"></script>
        <script type="text/javascript" src="../css/h-ui/js/H-ui.js"></script>
        <script type="text/javascript" src="../css/h-ui.admin/js/H-ui.admin.js"></script>
